		...
		switch (depth) {
			...
			case 6:
				...
				if (Dungeon.prisonalt == true) {
					...
					return new ArrayList<>(Arrays.asList(
							Frosthead.class,
							Frosthead.class, Frosthead.class, Crab.class,
							CM01.class));
			...
			case 7:
				...
				if (Dungeon.prisonalt == true) {
					...
					return new ArrayList<>(Arrays.asList(
							Frosthead.class,
							Frosthead.class, Frosthead.class,
							MeatRack.class,
							CM01.class,
							GlassKnight.class));
			...
			case 8:
				...
				if (Dungeon.prisonalt == true) {
					...
					return new ArrayList<>(Arrays.asList(
							Frosthead.class,
							Frosthead.class, CM01.class,
							CM01.class,
							MeatRack.class,
							GlassKnight.class, GlassKnight.class,
							LongLegs.class));

				} else return new ArrayList<>(Arrays.asList(Skeleton.class, Skeleton.class,
						Thief.class,
			...
			case 11:
				...
				if (Dungeon.cavealt == true) {
					return new ArrayList<>(Arrays.asList(
							...
							TrollArcher.class, TrollBrawler.class));
				} else {
					return new ArrayList<>(Arrays.asList(
			...
			case 12:
				...
				if (Dungeon.cavealt == true) {
					return new ArrayList<>(Arrays.asList(
							...
							TrollBrawler.class, TrollBrawler.class,
							TrollArcher.class, Elemental.CoalElemental.class));
				} else {
					return new ArrayList<>(Arrays.asList(
							Bat.class, Bat.class,
			...
			case 13:
				...
				if (Dungeon.cavealt == true) {
					return new ArrayList<>(Arrays.asList(
							GraniteTroll.class, RockGolem.class,
							TrollBrawler.class, TrollBrawler.class,
							TrollArcher.class, TrollArcher.class,
							Elemental.CoalElemental.class, Elemental.CoalElemental.class));
				} else {
					return new ArrayList<>(Arrays.asList(
							Bat.class,
							Brute.class, Brute.class,
			...
			case 15:
				...
				if (Dungeon.cavealt == true) {
					return new ArrayList<>(Arrays.asList(
							GraniteTroll.class, RockGolem.class,
							RockGolem.class, TrollBrawler.class,
							TrollArcher.class, TrollArcher.class,
							Elemental.CoalElemental.class, Elemental.CoalElemental.class));
				} else {
					return new ArrayList<>(Arrays.asList(
			...
			case 17:
				...
				if (Dungeon.cityalt == true) {
					return new ArrayList<>(Arrays.asList(
							Cultist.class, Giant.class, Trapper.class,
							Giant.class,
							Leader.class));
				} else {
					return new ArrayList<>(Arrays.asList(
			...
			case 20:
				...
				if (Dungeon.cityalt == true) {
					return new ArrayList<>(Arrays.asList(
							Alchemist.class, Giant.class, Trapper.class,
							Trapper.class,
							Leader.class, Leader.class,
		...
		for (int i = 0; i < rotation.size(); i++) {
			if (Random.Int(50) == 0) {
				...
				if (cl == Rat.class) {
					...
					cl = Acidic.class;
				} else if (cl == Toad.class) {
					cl = PoisonToad.class;
				} else if (cl == MeatRack.class) {
					cl = SpareRibs.class;
				} else if (cl == RockGolem.class) {
					cl = DemonicGolem.class;
				}
				rotation.set(i, cl);
			}
		}
