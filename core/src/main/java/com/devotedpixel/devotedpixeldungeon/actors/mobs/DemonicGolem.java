...
import com.shatteredpixel.shatteredpixeldungeon.sprites.DemonicGolemSprite;
...
public class DemonicGolem extends RockGolem {

	{
		spriteClass = DemonicGolemSprite.class;
	...
	public void die(Object src) {
		...
		while (i > 0) {
			...
			if (candidates.size() > 0) {
				...
				RockGolem clone = new RockGolem();
				clone.HP = HT / 2;
				clone.pos = Random.element(candidates);
				clone.state = clone.HUNTING;

				GameScene.add(clone, 1);
