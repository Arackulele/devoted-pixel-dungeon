...
import com.shatteredpixel.shatteredpixeldungeon.sprites.AshenLungSprite;
...
public class AshenLung extends Mob {

	{
		spriteClass = AshenLungSprite.class;
