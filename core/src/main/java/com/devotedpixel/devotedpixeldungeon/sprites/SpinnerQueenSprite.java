...
public class SpinnerQueenSprite extends MobSprite {
	
	public SpinnerQueenSprite() {
		super();

		perspectiveRaise = 0f;

		texture( Assets.Sprites.SPINNERQUEEN );
