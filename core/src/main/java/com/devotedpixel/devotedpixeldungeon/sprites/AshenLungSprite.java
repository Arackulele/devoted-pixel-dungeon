...
public class AshenLungSprite extends MobSprite {

	public AshenLungSprite() {
		super();

		texture( Assets.Sprites.LUNG );
		...
		idle.frames( frames, 0, 1, 3, 3, 3, 2, 0, 0, 0, 2, 3, 3, 3, 3, 1, 1, 0, 0, 0, 1, 3 , 3, 3, 2, 0, 0 );

		run = idle.clone();

		attack = idle.clone();

		die = new Animation( 2, true );
		die.frames( frames, 1, 0, 4, 5, 6 );
