...
public class ShadowStalkerSprite extends MobSprite {
	
	public ShadowStalkerSprite() {
		super();
		
		texture( Assets.Sprites.STALKER );
		
		TextureFilm frames = new TextureFilm( texture, 13, 15 );
		
		idle = new Animation( 8, true );
		idle.frames( frames, 0, 0, 0, 0, 0, 9, 9, 9 );
	...
	public void die() {
		super.die();
		emitter().burst( Speck.factory( Speck.SMOKE ), 6 );
