...
import com.shatteredpixel.shatteredpixeldungeon.ui.changelist.v0_1_Changes;
...
public class ChangesScene extends PixelScene {
	...
	public void create() {
		...
		switch (changesSelected){
			case 0: default:
				v0_1_Changes.addAllChanges(changeInfos);
				break;
		...
		StyledButton btn1_1 = new StyledButton(Chrome.Type.GREY_BUTTON_TR, "0.1.x"){
			@Override
