...
import com.shatteredpixel.shatteredpixeldungeon.levels.rooms.gardensboss.*;
...
public class GardenBossLevel extends GardenLevel {
	...
	protected ArrayList<Room> initRooms() {
		...
		StandardRoom gnollRoom = new DiamondEmperorRoom();
