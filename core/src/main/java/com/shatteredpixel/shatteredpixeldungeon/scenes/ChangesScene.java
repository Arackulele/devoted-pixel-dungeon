...
public class ChangesScene extends PixelScene {
	...
	public void create() {
		...
		switch (changesSelected){
			case 0: default:
				v1_X_DevotedChanges.addAllChanges(changeInfos);
				v0_1_DevotedChanges.addAllChanges(changeInfos);
				break;
			case 1:
		...
		StyledButton btn3_X = new StyledButton(Chrome.Type.GREY_BUTTON_TR, "Devoted", 8){
			@Override
		...
		StyledButton btn2_X = new StyledButton(Chrome.Type.GREY_BUTTON_TR, "Shattered", 8){
			@Override
			protected void onClick() {
				super.onClick();
