    ...
    public WndHeroInfo(HeroClass cl) {
        ...
        switch (cl) {
            ...
            case CLERIC:
                ...
                break;
            case ZEALOT:
                tabIcon = new ItemSprite(ItemSpriteSheet.ARTIFACT_VIAL3, null);
                break;
        }
        ...
        public HeroInfoTab(HeroClass cls) {
            ...
            switch (cls) {
                ...
                case CLERIC:
                    ...
                    break;
                case ZEALOT:
                    icons = new Image[]{new ItemSprite(ItemSpriteSheet.ARTIFACT_VIAL3),
                            //Icons.TALENT.get(),
                            new ItemSprite(ItemSpriteSheet.WARPICK),
                            new ItemSprite(ItemSpriteSheet.SCROLL_ISAZ)};
                    break;
            }
            for (Image im : icons) {
