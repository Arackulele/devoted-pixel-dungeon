...
import com.shatteredpixel.shatteredpixeldungeon.actors.buffs.ConjureAbility;
...
public class WndConjurerSummoning extends Window {
	...
	public WndConjurerSummoning(ConjureAbility energyBuff ){
		super();
		...
		for (ConjureAbility.ConjureMobs abil : ConjureAbility.ConjureMobs.abilities) {
			String text = "_" + Messages.titleCase(abil.name()) + " " + Messages.get(this, "cost", abil.energyCost()) + ":_ " + abil.desc();
	...
	ConjureAbility.ConjureMobs abilityBeingUsed;
