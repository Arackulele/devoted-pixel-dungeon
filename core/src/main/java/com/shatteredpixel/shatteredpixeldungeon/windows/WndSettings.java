    ...
    private static class DisplayTab extends Component {
        ...
        protected void createChildren() {
            ...
            if (DeviceCompat.isAndroid()) {
                ...
                chkLandscape.checked(Boolean.TRUE.equals(SPDSettings.landscape()));
                add(chkLandscape);
            }
                    ...
                    protected void onClick() {
                        ShatteredPixelDungeon.scene().addToFront(new Window(){
...

                            {
                                ...
                                if (width > 200) {
                                    chkFlipToolbar.setRect(0, swapperDesc.bottom() + GAP, (float) width / 2 - 1, BTN_HEIGHT);
                                    chkFlipTags.setRect(chkFlipToolbar.right() + GAP, chkFlipToolbar.top(), (float) width / 2 - 1, BTN_HEIGHT);
                                } else {
            ...
            if (currLang != Languages.ENGLISH) {
                ...
                btnCredits = new RedButton(credText, credText.length() > 9 ? 6 : 9) {
                    ...
                    protected void onClick() {
                        ...
                        Window credits = new Window(0, 0, Objects.requireNonNull(Chrome.get(Chrome.Type.TOAST)));
