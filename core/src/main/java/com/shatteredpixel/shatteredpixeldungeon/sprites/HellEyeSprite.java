...
import com.shatteredpixel.shatteredpixeldungeon.actors.mobs.HellEye;
...
public class HellEyeSprite extends MobSprite {
	
	public HellEyeSprite () {
		super();
		
		texture( Assets.Sprites.HELL_EYE );
	...
	public void zap( int pos ) {
		...
		if (enemy != null) {
			parent.add(new Lightning(origin, enemy.sprite.destinationCenter(), (HellEye) ch));
		} else {
			parent.add(new Lightning(origin, pos, (HellEye) ch));
		}
