...
import com.shatteredpixel.shatteredpixeldungeon.actors.mobs.altregion.Wendar;
...
public class WendarSprite extends MobSprite {
	...
	public WendarSprite() {
		...
		attack.frames( frames, 4+n, 5+n, 6+n, 4+n);
	...
	public void link(Char ch) {
		...
		ChargeParticles.pour(CourtParticle.WENDAR, 0.1f);
	...
	private void CheckParticles()
	{
		...
		if ((  thym.TWCombo || thym.YWCombo || thym.TripleCombo  )  ){
