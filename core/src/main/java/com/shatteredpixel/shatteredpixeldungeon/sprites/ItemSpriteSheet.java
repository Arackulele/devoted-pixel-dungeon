...
public class ItemSpriteSheet {
    ...
    public static final int WARPICK     = WEP_TIER1+6;
    static{
    ...
    public static final int WOODEN_BOOMERANG= MISSILE_WEP+16;
    ...
    static{
        ...
        assignItemRect(WOODEN_BOOMERANG,12, 12);
    ...
    public static final int DARTS    =                                      xy(1, 12);  //16 slots
    ...
    public static final int ARMOR_ZEALOT    = ARMOR+11;
    static{
        ...
        assignItemRect(ARMOR_ZEALOT,    15, 15);
    }
    ...
    public static final int WAND_MALAISE    	= WANDS+13;
    static {
    ...
    public static final int RING_ENDOTHERMIC= RINGS+12;
    static {
        for (int i = RINGS; i < RINGS+16; i++)
            assignItemRect(i, 8, 10);

        assignItemRect(RING_ENDOTHERMIC,       8, 11);
    }
    ...
    public static final int ARTIFACT_VIAL1       = ARTIFACTS+24;
    public static final int ARTIFACT_VIAL2       = ARTIFACTS+25;
    public static final int ARTIFACT_VIAL3       = ARTIFACTS+26;
    public static final int ARTIFACT_THORNCLOAK  = ARTIFACTS+27;

    public static final int ARTIFACT_KEY  = ARTIFACTS+28;
    ...
    static{
        ...
        assignItemRect(ARTIFACT_VIAL1,       13, 14);
        assignItemRect(ARTIFACT_VIAL2,       13, 14);
        assignItemRect(ARTIFACT_VIAL3,       13, 14);
        assignItemRect(ARTIFACT_THORNCLOAK, 16, 14);
        assignItemRect(ARTIFACT_KEY, 16, 14);
    ...
    private static final int FOOD       =                                   xy(1, 29);  //16 slots
    ...
    public static final int MEAL   = FOOD+13;
    public static final int WYVERNFRUIT   = FOOD+14;
    static{
        ...
        assignItemRect(MEAL,   			16, 14);
        assignItemRect(WYVERNFRUIT,   	12, 13);
    }

    private static final int HOLIDAY_FOOD   =                               xy(1, 30);  //16 slots
    ...
    public static final int BLOCK   = QUEST+0;
