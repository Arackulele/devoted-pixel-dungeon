...
public class Dungeon {
	...
	public static void init() {
		...
		SageCorpse.Quest.reset();
		Blacksmith.Quest.reset();
		BountyHunter.Quest.reset();
		Imp.Quest.reset();
		...
		if (branch == 0) {
			switch (depth) {
				...
				case 14:
					...
					break;
				case 15:
					if (cavealt == true) level = new ForgeBossLevel();
	...
	private static final String CAVESRANDOM	= "CAVESRANDOM";
    private static final String CITYRANDOM	= "CITYRANDOM";
    private static final String HALLSRANDOM	= "HALLSRANDOM";
	...
	public static void saveGame( int save ) {
		try {
			...
			SageCorpse	.Quest.storeInBundle( quests );
			Blacksmith	.Quest.storeInBundle( quests );
			BountyHunter.Quest.storeInBundle( quests );
	...
	public static void loadGame( int save, boolean fullLoad ) throws IOException {
		...
		if (fullLoad) {
			...
			if (!quests.isNull()) {
				...
				SageCorpse.Quest.restoreFromBundle( quests );
				Wandmaker.Quest.restoreFromBundle( quests );
				Blacksmith.Quest.restoreFromBundle( quests );
				BountyHunter.Quest.restoreFromBundle( quests );
		...
		cavesrandom = bundle.getInt(CAVESRANDOM);
