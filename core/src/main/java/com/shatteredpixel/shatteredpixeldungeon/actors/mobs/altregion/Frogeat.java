...
public abstract class Frogeat extends Mob {
    ...
    public static class PoisonFrogeat extends Frogeat {
        ...
        protected void DeathEffect(int pos) {
            ...
            if (Actor.findChar(pos) != null)Buff.affect(Actor.findChar(pos), Poison.class).set(Math.max(5f, hunger * 0.15f));
    ...
    public static class BleedingFrogeat extends Frogeat {
        ...
        protected void DeathEffect(int pos) {
            ...
            if (Actor.findChar(pos) != null)Buff.affect(Actor.findChar(pos), Bleeding.class).set(Math.max(5f, hunger * 0.15f));
    ...
    public static class ConfusingFrogeat extends Frogeat {
        ...
        protected void DeathEffect(int pos) {
            ...
            if (Actor.findChar(pos) != null) {Buff.affect(Actor.findChar(pos), Vertigo.class, Math.max(10f, hunger * 0.2f));
