...
import com.shatteredpixel.shatteredpixeldungeon.effects.particles.ThornsParticle;
...
public class Thorns extends Blob {
	...
	public static void affectChar( Char ch ){
		if (ch.alignment == Char.Alignment.ALLY) Buff.affect( ch, Bleeding.class ).set( 7 );
		else Buff.affect(ch, Healing.class).setHeal(7, 0, 1);
	}
	...
	public void use( BlobEmitter emitter ) {
		...
		emitter.pour( ThornsParticle.FACTORY, 0.7f );
	}
