...
public class v0_1_DevotedChanges {
    ...
    public static void add_v0_2_X_Changes(ArrayList<ChangeInfo> changeInfos) {
        ...
        changes.addButton(new ChangeButton(new ItemSprite(ItemSpriteSheet.RING_AGATE), "New Mystical Items",
    ...
    public static void add_v0_1_1_Changes(ArrayList<ChangeInfo> changeInfos) {
        ...
        changes.addButton(new ChangeButton(new ItemSprite(ItemSpriteSheet.ARTIFACT_TOME), "New Major Quest",
                "There is a Quest: the _Troll Child Quest._\n\n" +
    ...
    public static void add_v0_1_0_Changes(ArrayList<ChangeInfo> changeInfos) {
        ...
        changes.addButton(new ChangeButton(new ItemSprite(ItemSpriteSheet.ARTIFACT_VIAL3), "New Artifact",
