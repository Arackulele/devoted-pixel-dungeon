    ...
    public static void add_v1_0_0_Beta_8_Changes( ArrayList<ChangeInfo> changeInfos ) {
        ...
        changes.addButton(new ChangeButton(Icons.get(Icons.INFO), "Shattered Version Update",
                "Devoted PD is now based on version 3.3.7 of Shattered Pixel Dungeon\n" +
                        ...
                        "\n" +
                        "The randomize functionality has also been implemented, and should randomize regions too for random runs"
        ...
        changes.addButton(new ChangeButton(new Image(Assets.Sprites.SPINNER, 144, 0, 16, 16), Messages.get(ChangesScene.class, "bugfixes"),
                "-A crash in the final boss fights final phase\n" +
                        ...
                        "Hotfixes ( Beta 8.1 ):\n" +
                        "-Fixed an error where the mobile version crashed when opened in vertical mode\n" +
                        "-The game is once again able to open the bestiary on all operating systems without crashing\n" +
                        "-The Zealot can once again be unlocked by crafting a trinket\n" +
                        "-Custom Notes on items are readable again without displaying a no text found message"
        ));
