	...
	public static class LandmarkRecord extends Record {
		...
		public Image icon(){
			switch (landmark){
				...
				case SAGECORPSE:
					return new Image(new SageCorpseSprite());
				case WANDMAKER:
					return new Image(new WandmakerSprite());
				case TROLL:
					return new Image(new BlacksmithSprite());
				case BOUNTYHUNTER:
					return new Image(new BountyHunterSprite());
				case IMP:
		...
		public String desc() {
			switch (landmark) {
				...
				case SAGECORPSE:     return Messages.get(SageCorpse.class, "desc");
				case WANDMAKER:     return Messages.get(Wandmaker.class, "desc");
				case TROLL:         return Messages.get(Blacksmith.class, "desc");
				case BOUNTYHUNTER:         return Messages.get(BountyHunter.class, "desc");
