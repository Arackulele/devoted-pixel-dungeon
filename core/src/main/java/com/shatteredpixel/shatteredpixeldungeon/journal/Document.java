...
public enum Document {
	...
	static {
		...
		GARDENS_BOTANIST.pagesStates.put("gardens1",            debug ? READ : NOT_FOUND);
		GARDENS_BOTANIST.pagesStates.put("gardens2",            debug ? READ : NOT_FOUND);
		GARDENS_BOTANIST.pagesStates.put("gardens3",            debug ? READ : NOT_FOUND);
		GARDENS_BOTANIST.pagesStates.put("gardens4",            debug ? READ : NOT_FOUND);
		GARDENS_BOTANIST.pagesStates.put("gardens5",            debug ? READ : NOT_FOUND);
		GARDENS_BOTANIST.pagesStates.put("gardens6",            debug ? READ : NOT_FOUND);
