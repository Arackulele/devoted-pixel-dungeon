...
public enum Bestiary {
	...
	static {
		...
		REGIONAL.addEntities(
				...
				Toad.class, Grub.class, Butterfly.class, Druid.class, ThornLasher.class,
				Skeleton.class, Thief.class, DM100.class, Guard.class, Necromancer.class,
				ColdCorpse.class, MeatRack.class, Banshee.class, GlassKnight.class, Wererat.class,
		...
		RARE.addEntities(Albino.class, GnollExile.class ,HermitCrab.class, CausticSlime.class,
				PoisonToad.class, RoyalGrub.class,
		...
		ALLY.addEntities(MirrorImage.class, PrismaticImage.class,
				...
				Wisp.class, BlueImp.class, Wasp.class, Wretch.class, Homonculus.class,
