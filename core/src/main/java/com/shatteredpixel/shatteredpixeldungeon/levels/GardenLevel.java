...
public class GardenLevel extends RegularLevel {
	...
	public void destroy(int pos) {
		...
		if (terr == Terrain.REGION_DECO){
			...
			if (Random.Int(3) == 1){ // 33% chance to spawn a plant ( really 16.7% since half dont drop anything )
		...
		else super.destroy(pos);
	}
	
	@Override
	public String waterTex() {
		return Assets.Environment.WATER_GARDEN;
	}
	...
	public String tileName( int tile ) {
		switch (tile) {
			...
			case Terrain.STATUE:
				return Messages.get(GardenLevel.class, "statue_name");
			case Terrain.GRASS:
				return Messages.get(GardenLevel.class, "grass_name");
			case Terrain.HIGH_GRASS:
				return Messages.get(GardenLevel.class, "high_grass_name");
			case Terrain.EMPTY_DECO:
				return Messages.get(GardenLevel.class, "empty_deco_name");
			case Terrain.REGION_DECO:
			case Terrain.REGION_DECO_ALT:
				return Messages.get(GardenLevel.class, "region_deco_name");
			default:
	...
	public String tileDesc(int tile) {
		switch (tile) {
			...
			case Terrain.WATER:
				return Messages.get(GardenLevel.class, "water_desc");
			case Terrain.STATUE:
				return Messages.get(GardenLevel.class, "statue_desc");
			case Terrain.WALL_DECO:
				return Messages.get(GardenLevel.class, "wall_deco_desc");
			...
			case Terrain.REGION_DECO:
			case Terrain.REGION_DECO_ALT:
				return Messages.get(GardenLevel.class, "region_deco_desc");
			default:
