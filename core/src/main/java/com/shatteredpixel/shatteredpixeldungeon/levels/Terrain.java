...
public class Terrain {
	...
	public static final int MAGMA_TILE		= 50;
	...
	public static final int BOMBABLE		= 0x03;
	...
	public static final int DRYNESS			= 0x100;
	public static final int PIT				= 0x80;
	
	public static final int[] flags = new int[256];
	static {
		flags[CHASM]		= AVOID	| PIT;
		flags[EMPTY]		= PASSABLE | DRYNESS;
		flags[GRASS]		= PASSABLE | FLAMABLE | DRYNESS;
		...
		flags[ENTRANCE]		= PASSABLE | DRYNESS;
		flags[ENTRANCE_SP]	= flags[ENTRANCE];
		flags[EXIT]			= PASSABLE;
		flags[EMBERS]		= PASSABLE | DRYNESS;
		...
		flags[HIGH_GRASS]	= PASSABLE | LOS_BLOCKING | FLAMABLE | DRYNESS;
