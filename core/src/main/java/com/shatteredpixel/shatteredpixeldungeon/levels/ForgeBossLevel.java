...
import com.shatteredpixel.shatteredpixeldungeon.actors.mobs.altregion.BlastFurnace;
...
public class ForgeBossLevel extends Level {
	...
	public void playLevelMusic() {
		if (locked){
			Music.INSTANCE.play(Assets.Music.FORGE_BOSS, true);
	...
	14 + 35*WIDTH, 18 + 35*WIDTH,
	5 + 23*WIDTH, 5 + 27*WIDTH,
	27 + 23*WIDTH, 27 + 27*WIDTH,
	};
	...
	protected boolean build() {
		...
		new ForgePainter().paint(this, null);
	...
	public Group addVisuals() {
		ForgeLevel.addForgeVisuals(this);
		super.addVisuals();
		return visuals;
	}
	...
	private static final short A = Terrain.REGION_DECO;
	...
	public static class EntranceOverhang extends CustomTilemap{
		...
		{
			texture = Assets.Environment.FORGE_BOSS;
		}
