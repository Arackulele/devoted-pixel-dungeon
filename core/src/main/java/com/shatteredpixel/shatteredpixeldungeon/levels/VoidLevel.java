...
public class VoidLevel extends RegularLevel {
	...
	public void playLevelMusic() {
		Music.INSTANCE.play(Assets.Music.VOID, true);
	}
	...
	@Override
	public int mobLimit() {
		//because the 4 neuron sentries shouldnt count towards the limit
		return super.mobLimit()+4;
	}

    @Override
    protected void createMobs() {
        mobsToSpawn.add(NeuronSentry.class);
        mobsToSpawn.add(NeuronSentry.class);
        mobsToSpawn.add(NeuronSentry.class);
        mobsToSpawn.add(NeuronSentry.class);
        super.createMobs();
